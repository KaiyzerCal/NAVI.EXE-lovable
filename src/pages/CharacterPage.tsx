      ...
      {activeTab === "PROFILE" ? (
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <HudCard title="EQUIPMENT" icon={<Star size={14} />} glow>
            ...
            {/* Sub-class selector — real-world roles that map to this class */}
            <div className="mt-4 pt-3 border-t border-border">
              <p className="text-[10px] font-mono text-muted-foreground mb-2">
                SUB-CLASS // EQUIP A REAL-WORLD PATH
              </p>
              {profile.character_class && SUB_CLASSES[profile.character_class] ? (
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between mb-0.5">
                          <p className={`text-xs font-body font-semibold ${isEquipped ? "text-secondary" : "text-foreground"}`}>
                            {sub.name}
                          </p>
                          {isEquipped && (
                            <span className="text-[9px] font-mono text-secondary bg-secondary/10 px-1.5 py-0.5 rounded">
                              EQUIPPED
                            </span>
                          )}
                        </div>
                ...
                <p className="text-[10px] font-mono text-muted-foreground">
                  Complete the MBTI quiz to unlock sub-class options
                </p>
              )}
            </div>
          </HudCard>
