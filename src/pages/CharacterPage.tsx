...
import { Shield, Sword, Brain, Heart, Zap, Star, Eye, Plus, Trash2, Pencil, Check, X, ScanEye, Clover, Coins, Lock, ChevronRight, Layers, Wand2, Loader2 as LoaderIcon } from "lucide-react";
...
function SkinCard({
  skinId, isUnlocked, isEquipped, onEquip,
}: {
